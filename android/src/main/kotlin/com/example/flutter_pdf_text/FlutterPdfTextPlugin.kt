package com.example.flutter_pdf_text
...
/** FlutterPdfTextPlugin */
class FlutterPdfTextPlugin: FlutterPlugin, MethodCallHandler {
  override fun onAttachedToEngine(@NonNull flutterPluginBinding: FlutterPlugin.FlutterPluginBinding) {
    val channel = MethodChannel(flutterPluginBinding.binaryMessenger, "flutter_pdf_text")
    channel.setMethodCallHandler(FlutterPdfTextPlugin())
  ...
  companion object {
    ...
    fun registerWith(registrar: Registrar) {
      val channel = MethodChannel(registrar.messenger(), "flutter_pdf_text")
      channel.setMethodCallHandler(FlutterPdfTextPlugin())
